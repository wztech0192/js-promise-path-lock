export default class PromisePathLock {
    ...
    wrapIt = (funcName, ...arg) => new PromisePathLock(this.promise[funcName], this.pathname);

    then = (onSuccess, onError) =>
        this.wrapIt("then", this.generateCallback(onSuccess), this.generateCallback(onError));
